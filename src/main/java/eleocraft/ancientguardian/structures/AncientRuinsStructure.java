package eleocraft.ancientguardian.structures;
...
//    }
    ...
    public static class Start extends StructureStart<NoFeatureConfig>  {
        ...
        public void func_230364_a_(DynamicRegistries dynamicRegistryManager, ChunkGenerator chunkGenerator, TemplateManager templateManagerIn, int chunkX, int chunkZ, Biome biomeIn, NoFeatureConfig config) {
            ...
            BlockPos blockpos = new BlockPos(x, 10, z);
            int AirCount = 0;
            IBlockReader blockreader =  chunkGenerator.func_230348_a_(x, z);
            for (int y=0;y<128;y++)
            {
            	BlockPos pos = new BlockPos(x, y, z);
                BlockState state = blockreader.getBlockState(pos);
            	if (state.getBlock().isAir(state, blockreader, pos))
            	{
            		AirCount++;
            		if (AirCount == 6)
            		{
            			blockpos = new BlockPos(pos.getX(), pos.getY() - 6, pos.getZ());
            			break;
            		}
            	}
            	else
            ...
            JigsawManager.func_242837_a(
                    ...
                    new VillageConfig(() -> dynamicRegistryManager.getRegistry(Registry.JIGSAW_POOL_KEY)
                            ...
                            .getOrDefault(new ResourceLocation("ancientguardian", "ancientruins/start_pool")),
            ...
            ancientguardian.LOGGER.log(Level.DEBUG, "Rundown House at " +

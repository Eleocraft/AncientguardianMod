...
public class StructureConfig {
     ...
     */
    public static StructureFeature<?, ?> ANCIENTRUINS = StructureList.ANCIENTRUINS.get().withConfiguration(IFeatureConfig.NO_FEATURE_CONFIG);
    ...
    public static void registerConfiguredStructures() {
        ...
        Registry.register(registry, new ResourceLocation("ancientguardian", "ancientruins"), ANCIENTRUINS);
        ...
        FlatGenerationSettings.STRUCTURES.put(StructureList.ANCIENTRUINS.get(), ANCIENTRUINS);
    }
}
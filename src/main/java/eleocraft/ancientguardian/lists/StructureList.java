...
import eleocraft.ancientguardian.structures.AncientRuinsStructure;
...
public class StructureList {
     ...
     */
    public static final DeferredRegister<Structure<?>> DEFERRED_REGISTRY_STRUCTURE = DeferredRegister.create(ForgeRegistries.STRUCTURE_FEATURES, "ancientguardian");
     ...
     */
    public static final RegistryObject<Structure<NoFeatureConfig>> ANCIENTRUINS = registerStructure("ancientruins", () -> (new AncientRuinsStructure(NoFeatureConfig.field_236558_a_)));
    ...
    public static void setupStructures() {
        setupMapSpacingAndLand(
                ANCIENTRUINS.get(), /* The instance of the structure */
                new StructureSeparationSettings(10 /* maximum distance apart in chunks between spawn attempts */,
                        ...
                        248979821 /* this modifies the seed of the structure so no two structures always spawn over each-other. Make this large and unique. */),
                true);
